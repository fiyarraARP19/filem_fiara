...
import 'package:filem_fiara/models/movie.dart';
import 'package:filem_fiara/screens/detail_screen.dart';
import 'package:filem_fiara/services/api_service.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadMovies() async {
    ...
    setState(() {
      _allMovies = allMoviesData.map((e) => Movie.fromJason(e)).toList();
      _trendingMovies =
          trendingMoviesData.map((e) => Movie.fromJason(e)).toList();
      _popularMovies =
          popularMoviesData.map((e) => Movie.fromJason(e)).toList();
    });
  }
